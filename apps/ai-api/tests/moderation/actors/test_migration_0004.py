"""Migration lifecycle for revision 0004 — telegram_users, moderators, telegram_messages,
moderator_group_assignments (Principle I: migrations that transform schema; FR-068, SC-030).
...
def test_empty_to_0004(test_url: str) -> None:
...
def test_head_down_to_0003_up_returns_to_the_identical_version_with_no_manual_repair(
    test_url: str,
) -> None:
